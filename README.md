...
# Upgrade Notes (May 2025)

This project has been upgraded to Next.js 14.1.0 from 14.0.4. The upgrade includes:

- Performance improvements with SWC minification enabled
- Enhanced React Strict Mode
